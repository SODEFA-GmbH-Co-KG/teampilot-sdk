...
If you use the SDK and really don't want caching, you can either set cacheTtlSeconds on every request to 0 or set the default value in your environment variable TEAMPILOT&shy;_DEFAULT&shy;_CACHE&shy;_TTL&shy;_SECONDS or NEXT&shy;_PUBLIC&shy;_TEAMPILOT&shy;_DEFAULT&shy;_CACHE&shy;_TTL&shy;_SECONDS to 0.
If both are set, TEAMPILOT&shy;_DEFAULT&shy;_CACHE&shy;_TTL&shy;_SECONDS will be used.
`
