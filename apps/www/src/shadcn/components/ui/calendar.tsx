  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        head_row: "flex",
        head_cell:
          "text-muted-foreground rounded-md w-6 sm:w-9 font-normal text-[0.75rem] sm:text-[0.8rem]",
        ...
        day: cn(
          ...
          "h-6 w-6 sm:h-9 sm:w-9 p-0 font-normal aria-selected:opacity-100 max-sm:text-xs"
        ),
        day_selected:
